...
# Jing
## Document
https://docs.google.com/document/d/1pYnOR_cm4b9A2UaXXbKyrCZhAXQKa5A7s-oUkEk5fh0/edit?usp=sharing

## Procedure
```bash
cp -fr ../echo-bot-ts ~/Desktop/work
cd ~/Desktop/work/echo-bot-ts
tar -xvf git.tgz
```
